...
for label_text, test_id in pruebas:
    # Aquí se controla qué función abrir para cada prueba
    if test_id == 2:
    ...
    # Crear el botón para cada prueba
    ...
    # Crear el Checkbutton para seleccionar la prueba
    ...
    # Crear el campo de texto para los resultados de las pruebas 14 y 15
    if test_id in [14, 15]:
    ...
    # Crear una etiqueta para mostrar si la prueba es aleatoria o no
    ...
    # Incrementar la fila para la siguiente prueba
    row += 1
