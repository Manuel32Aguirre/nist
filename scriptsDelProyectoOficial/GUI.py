...
class RandomExcursionTestItem:
    ...
    def __init__(self, master, title, x_coor, y_coor, data, variant=False, font_size=11):
        ...
        state_label = LabelTag(master, 'Estado', (x_coor + 60), (y_coor + 30), width=100, font_size=font_size, border=2, relief='groove')
        if variant:
        ...
        if not variant:
            ...
            count_label = LabelTag(master, 'Contar', (x_coor + 165), (y_coor + 30), width=350, font_size=font_size,
            ...
            pass
        p_value_label = LabelTag(master, 'Valores', (x_coor + 520), (y_coor + 30), width=350, font_size=font_size, border=2,
                               relief='groove')
        p_value_Entry = Entry(master, textvariable=self.__p_value)
        p_value_Entry.config(state=DISABLED)
        p_value_Entry.place(x=(x_coor + 520), y=(y_coor + 60), width=350, height=25)
        conclusion_label = LabelTag(master, 'Resultado', (x_coor + 875), (y_coor + 30), width=150, font_size=font_size, border=2,
                               relief='groove')
